...
#SBATCH --job-name=star_mapping2
#SBATCH --output=star_mapping2-%j.out
...
OUT_DIR=/home/jkt21/mnt/network/bioinformatics/users/jkt21/rnaseq_GSE81089_workflow/star/star_aligned
